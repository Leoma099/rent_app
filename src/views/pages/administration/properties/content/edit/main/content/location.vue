        ...
        <div class="card card-body card-white rounded-0 p-4">
            ...
            <div class="mt-3 d-flex gap-2">
                <input
                    ...
                    ref="inputRef"
                />
                <button type="button" class="btn btn-outline-secondary" @click="clearMap">Clear Map</button>
            </div>
...
export default
{
    ...
    methods:
    {
        ...
        clearMap()
        {
            ...
            if (this.innerCircle) { this.innerCircle.setMap(null); this.innerCircle = null; }
            if (this.outerCircle) { this.outerCircle.setMap(null); this.outerCircle = null; }
